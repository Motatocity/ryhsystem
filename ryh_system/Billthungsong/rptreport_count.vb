...
Public Class rptreport_count
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ryh_system.rptreport_count.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrptreport_count
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptreport_count = New rptreport_count()
        rpt.Site = Me.Site
        Return rpt
    End Function
