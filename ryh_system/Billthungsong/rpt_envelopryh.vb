...
Public Class rpt_envelopryh
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ryh_system.rpt_envelopryh.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_envelopryh
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_envelopryh = New rpt_envelopryh()
        rpt.Site = Me.Site
        Return rpt
    End Function
