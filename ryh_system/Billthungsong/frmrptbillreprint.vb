...
Public Class frmrptbillreprint
    ...
    Private Sub frmrptbillreprint_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If frmmain_thungsong.checkTHUNGANDRYH = "0" Then
            'mySqlCommand.CommandText = "SELECT * FROM thungsong_bill join  thungsongdb on thungsongdb.idthungsongDB = thungsong_bill.idname  where idthungsong_bill = '" & frmreprint.idlast & "' ;"

            mySqlCommand.CommandText = "SELECT * FROM thungsong_rec left join    thungsong_round ON thungsong_rec.idthungsong_round = thungsong_round.idthungsong_round    left join thungsongdb on thungsongdb.idthungsongDB = thungsong_round.thungsong_roundbill  where IDTHUNGSONGBILL = '" & frmreprint.idlast & "' ;"
            ...
            Try
                ...
                While (mySqlReader.Read())
                    ...
                    If mySqlReader("thungsong_type").ToString = "เงินสด" Then
                        rpt1.SetParameterValue("price_1", mySqlReader("thungsong_sum"))
                        rpt1.SetParameterValue("pricename1", frmreprint.thaitext)
                    ...
                    Else
                        ...
                        rpt1.SetParameterValue("pricename", frmreprint.thaitext)
                    ...
                    rpt1.SetParameterValue("nameage", frmreprint.age)
        ...
        If mysql.State = ConnectionState.Closed Then
            mysql.Open()
        End If
            ' mySqlCommand.CommandText = "SELECT *   FROM ryh_main JOIN ryh_sum  ON ryh_main.idryh_main = ryh_sum.ID JOIN ryh_sumdetail ON ryh_sum.idryh_sum = ryh_sumdetail.idryh_sum  JOIN ryh_billdet ON  ryh_billdet.idryh_sumdet = ryh_sumdetail.idryh_sumdetail  where idryh_billdet = '" & frmreprint.idlast & "' ;"


            mySqlCommand.CommandText = "SELECT *   FROM ryh_main JOIN ryh_sumdetail  ON ryh_main.idryh_main = ryh_sumdetail.idryh_main JOIN ryh_billdet ON ryh_sumdetail.idryh_sumdetail = ryh_billdet.idryh_sumdet   where idryh_billdet  = '" & frmreprint.idlast & "' ;"
        ...
        Try
            ...
            While (mySqlReader.Read())
                ...
                rpt2.SetParameterValue("nameprice", " ")
                    If mySqlReader("ryh_type").ToString = "เงินสด" Then
                        rpt2.SetParameterValue("price_1", mySqlReader("ryh_sum"))
                        rpt2.SetParameterValue("pricename1", frmreprint.thaitext)
                    ...
                    Else
                        ...
                        rpt2.SetParameterValue("pricename", frmreprint.thaitext)
                ...
                rpt2.SetParameterValue("bankid", mySqlReader("ryh_bankid"))
                    rpt2.SetParameterValue("nameage", frmreprint.age)
