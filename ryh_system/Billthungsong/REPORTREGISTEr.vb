...
Public Class REPORTREGISTEr
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ryh_system.REPORTREGISTEr.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DATEMSG() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_ADDRESSDATE() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedREPORTREGISTEr
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As REPORTREGISTEr = New REPORTREGISTEr()
        rpt.Site = Me.Site
        Return rpt
    End Function
