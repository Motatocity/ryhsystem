...
Public Class frmpackage2
    ...
    End Sub
    Private Sub frmpackage2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                        ...
                        If IsNumeric(tab5_txt_trigyceride.Text) Then
                            ...
                            ElseIf int_trigyceride > 150 Then
                                If check_sub = 0 Then
                                    ...
                                    tab5_result_trigyceride.Text = "ไขมันไตรกลีเซอไรด์ในเลือดสูง คำแนะนำ หลีกเลี่ยงหรือลดอาหารประเภทแป้ง คาร์โบไฮเดรตสูง ของหวาน สุรา เบียร์  เป็นต้น ออกกำลังกายสม่ำเสมอ และตรวจติดตาม หรือตามคำแนะนำของแพทย์"
                                ElseIf check_sub = 1 Then
        ...
        If e.KeyCode = "13" Then
            ...
            Try
                ...
                If string_count = 1 Then
                    ...
                    While mySqlReader.Read()
                        ...
                        Else
                            ...
                            If IsNumeric(tab4_txt_fbs.Text) Then
                                ...
                                ElseIf int_fbs >= 101 And int_fbs <= 125 Then
                                    tab4_result_fbs.Text = "การควบคุมน้ำตาลบกพร่อง คำแนะนำ ควรลดอาหาร แป้ง รับประทานผัก ผลไม้ มากขึ้น และตรวจซ้ำ 1 เดือน"
                                    result_all = result_all + count_result + ". การควบคุมน้ำตาลบกพร่อง คำแนะนำ ควรลดอาหาร แป้ง รับประทานผัก ผลไม้ มากขึ้น และตรวจซ้ำ 1 เดือน " + Environment.NewLine
                                    count_result = count_result + 1
                                ElseIf int_fbs > 125 Then
                                    tab4_result_fbs.Text = "มีภาวะเบาหวาน แนะนำควรพบแพทย์"
                                    result_all = result_all + count_result + ". มีภาวะเบาหวาน แนะนำควรพบแพทย์" + Environment.NewLine
                                    count_result = count_result + 1
                                ElseIf int_fbs < 50 Then
                                    tab4_result_fbs.Text = "ภาวะน้ำตาลในเลือดต่ำ คำแนะนำควรพบแพทย์เพื่อหาสาเหตุ"
                                    result_all = result_all + count_result + ". ภาวะน้ำตาลในเลือดต่ำ คำแนะนำควรพบแพทย์เพื่อหาสาเหตุ" + Environment.NewLine
                                    count_result = count_result + 1
                                End If
                            End If
                        ...
                        Else
                            ...
                            If IsNumeric(tab5_txt_bun.Text) Then
                                ...
                                ElseIf int_bun > 20 Then
                                    tab5_result_bun.Text = "การทำงานของไตสูงกว่าปกติ คำแนะนำ ตรวจติดตามทุกปี"
                                    result_all = result_all + count_result + ". การทำงานของไตสูงกว่าปกติ คำแนะนำ ตรวจติดตามทุกปี" + Environment.NewLine
                                    count_result = count_result + 1
                        ...
                        Else
                            ...
                            If IsNumeric(tab5_txt_uricacid.Text) Then
                                ...
                                ElseIf int_uricacid > 8.5 Then
                                    tab5_result_uricacid.Text = "สูงกว่าปกติ คำแนะนำ ควรหลีกเลี่ยงการรับประทานอาหารประเภทสัตว์ปีก เครื่องในสัตว์ หรือผักบางชนิด ยอดผัก เช่น หน่อไม้ กระถิน กะหล่ำปลี แอลกอฮอล์ เหล้า เบียร์ และตรวจติดตาม"
                                    result_all = result_all + "- ควรหลีกเลี่ยงการรับประทานอาหารประเภทสัตว์ปีก เครื่องในสัตว์ หรือผักบางชนิด ยอดผัก เช่น หน่อไม้ กระถิน กะหล่ำปลี แอลกอฮอล์ เหล้า เบียร์ และตรวจติดตาม" + Environment.NewLine
                                    count_result = count_result + 1
                                ElseIf int_uricacid < 2.5 Then
                                    tab5_result_uricacid.Text = "ไม่มีผลต่อการวินิจฉัย คำแนะนำ ตรวจติดตามทุกปี"
                                End If
                    ...
                    End While
                Else
                    Dim NextForm As frmpackage2_1 = New frmpackage2_1(mysqlpass, ipconnect, usernamedb, dbname, txtsearch.Text)
                    '  Dim NextForm As main_user = New main_user()
                    NextForm.Show()
                    Me.Close()
    ...
    Public Sub excelReport()
        ...
        Try
            excelbooks.SaveAs(pathExcel.ToString + "\" + txt_name.Text + "_P.2" + ".xlsx")
