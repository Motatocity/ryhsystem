...
Public Class frmpackage6
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        clear()
        tab6_result_psp.Text = "รอผลตรวจจะจัดสั่งให้ ภายใน 14 วัน"
        ...
        If id_hn <> "0" And export_id <> "0" Then
            ...
            ' Dim selectCMD As OdbcCommand = New OdbcCommand("SELECT * FR WHERE RMSHNNO='7708' and RMSHNYR = '56'")
                    ...
                    Else
                        ...
                        If IsNumeric(tab6_txt_ldl.Text) Then
                            ...
                            ElseIf int_ldl > 100 Then
                                If check_sub = 0 Then
                                    tab6_result_ldl.Text = "ปริมาณไขมันความหนาแน่นต่ำในเลือดสูง แนะนำ หลีกเลี่ยงหรือลดอาหารประเภทไขมันมาก ได้แก่ อาหารทะเล ไข่แดง เครื่องในสัตว์ เป็นต้น ออกกำลังกายสม่ำเสมอ และตรวจติดตาม หรือตามคำแนะนำของแพทย์"
                                ElseIf check_sub = 1 Then
            ...
            tab2_result_redmorphology.Text = result_redmorphology
        ...
        If e.KeyCode = "13" Then
            ...
            Try
                ...
                Else
                    ...
                    Dim NextForm As frmpackage6_1 = New frmpackage6_1(mysqlpass, ipconnect, usernamedb, dbname, txtsearch.Text, check_sub)
    ...
    Public Sub savedata()
        ...
        mysql1.ConnectionString = "server=" + ipconnect + ";user id=" + usernamedb + ";password=" + mysqlpass + ";database=" + dbname + ";Character Set =utf8;"
        Try
            mysql1.Open()
            '    MsgBox("CONNECTED TO DATABASE")
        Catch ex As Exception
    ...
    Public Sub bmi_cal()
        ...
        If tab1_tab_weight.Text <> " " And tab1_txt_height.Text <> " " And IsNumeric(tab1_tab_weight.Text) And IsNumeric(tab1_txt_height.Text) Then
    ...
    Public Sub excelReport()
        ...
        With excelsheets
            ...
            With .Range("B82:K82")
                .Merge()
                .Value = "ตรวจมะเร็งปากมดลูก (Pap Smear)"
                .Font.Bold = True
                .Font.Size = 14
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
        ...
        Try
            excelbooks.SaveAs(pathExcel.ToString + "\" + txt_name.Text + "_P.5" + ".xlsx")
    ...
    End Sub
    Private Sub ComboBox22_SelectedIndexChanged_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox22.SelectedIndexChanged
        If ComboBox22.Text = "1.ปกติ" Then
            tab1_result_pulse.Text = "อยู่ในเกณฑ์ปกติ (Normal)"
