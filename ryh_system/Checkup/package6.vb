...
Public Class package6
    ...
    Private Sub package6_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            While (mySqlReader.Read())
                'same all page
                If mySqlReader("p_id") Is DBNull.Value Then

                Else
                    txtsearch.Text = mySqlReader("p_id")
                End If
                If mySqlReader("p_name") Is DBNull.Value Then

                Else
                    txt_name.Text = mySqlReader("p_name")
                End If

                If mySqlReader("p_sex") Is DBNull.Value Then

                Else
                    txt_sex.Text = mySqlReader("p_sex")
                End If

                If mySqlReader("p_age") Is DBNull.Value Then

                Else
                    txt_age.Text = mySqlReader("p_age")
                End If

                If mySqlReader("p_tell") Is DBNull.Value Then

                Else
                    txt_tell.Text = mySqlReader("p_tell")
                End If

                If mySqlReader("p_add") Is DBNull.Value Then
                ...
                tab6_result_psp.Text = mySqlReader("result_psp")
