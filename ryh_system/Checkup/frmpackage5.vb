...
Public Class frmpackage5
    ...
    End Sub
    Private Sub frmpackage5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            Try
                ...
                While mySqlReader.Read()
                    ...
                    If mySqlReader("R17") Is "Normal" Then
                        ...
                        tab2_txt_redcell.Text = "อยู่ในเกณฑ์ปกติ(Normal)"
                    ...
                    Else
                        ...
                        If IsNumeric(tab5_txt_hdl.Text) Then
                            ...
                            ElseIf int_hdl > 60 Then
                                If check_sub = 0 Then
                                    tab5_result_hdl.Text = "ปริมาณไขมันความหนาแน่นสูง  มีระดับดี  ลดภาวะเสี่ยงจากโรคหลอดเลือดหัวใจและหลอดเลือดสมองตีบ"
                                ElseIf check_sub = 1 Then
                            ...
                            ElseIf int_hdl < 40 Then
                                If check_sub = 0 Then
                                    tab5_result_hdl.Text = "ปริมาณไขมันความหนาแน่นสูง ต่ำกว่าปกติ เพิ่มความเสี่ยงต่อโรคหลอดเลือดหัวใจและหลอดเลือดสมองตีบ แนะนำออกกำลังกายสม่ำเสมอ งดสูบบุหรี่ รับประทานอาหารจำพวกผัก เนื้อปลามากขึ้น"
                                ElseIf check_sub = 1 Then
                    ...
                    Else
                        ...
                        If IsNumeric(tab6_txt_afp.Text) Then
                            ...
                            ElseIf int_afp > 7.51 Then
                                ...
                                tab6_result_afp.Text = "ค่าบ่งชี้มะเร็งในตับสูงกว่าในปกติ แนะนำตรวจติดตามกับอายุรแพทย์ ระบบทางเดินอาหาร"
                    ...
                    Else
                        ...
                        If IsNumeric(tab6_txt_alkaline.Text) Then
                            ...
                            ElseIf int_alk > 126 And int_alk < 199 Then
                                ...
                                If check_sub = 0 Then
                                    tab6_result_alkaline.Text = "สูงกว่าปกติ แนะนำ แนะนำตรวจติดตามและตรวจซ้ำภายใน 3 เดือน"
                                ElseIf check_sub = 1 Then
                            ...
                            ElseIf int_alk > 200 Then
                                If check_sub = 0 Then
                                    tab6_result_alkaline.Text = "สงสัยมีภาวะอุดกั้นทางเดินน้ำดี แนะนำ แนะนำปรึกษาแพทย์"
                                ElseIf check_sub = 1 Then
                            ...
                            ElseIf int_alk < 38 Then
                                ...
                                If check_sub = 0 Then
                                    tab6_result_alkaline.Text = "ไม่มีผลต่อการวินิจฉัย แนะนำ ตรวจติดตาม"
                                ElseIf check_sub = 1 Then
                    ...
                    End If
                    If mySqlReader("R60") Is DBNull.Value Or mySqlReader("R60") Is "-" Then
                    ...
                    Else
                        ...
                        If IsNumeric(tab6_txt_ldl.Text) Then
                            ...
                            ElseIf int_ldl > 100 Then
                                If check_sub = 0 Then
                                    tab6_result_ldl.Text = "ปริมาณไขมันความหนาแน่นต่่ำในเลือดสูง แนะนำ หลีกเลี่ยงหรือลดอาหารประเภทไขมันมาก ได้แก่ อาหารทะเล ไข่แดง เครื่องในสัตว์  เป็นต้น ออกกำลังกายสม่ำเสมอ และตรวจติดตาม หรือตามคำแนะนำของแพทย์"
                                ElseIf check_sub = 1 Then
                    ...
                    If mySqlReader("R67") Is DBNull.Value Then
                        tab6_txt_pap.BackColor = Color.DarkSeaGreen
                        tab6_txt_pap.Text = " "
                    Else
                        tab6_txt_pap.Text = mySqlReader("R67")
                        Dim int_afp As Double
                        If IsNumeric(tab6_txt_pap.Text) Then
                            int_afp = Double.Parse(tab6_txt_pap.Text)
                            tab6_txt_pap.Text = int_afp

                            If int_afp >= 0 And int_afp <= 4 Then
                                tab6_result_afp.Text = "อยู่ในเกณฑ์ปกติ (Normal)"
                            ElseIf int_afp > 4 Then
                                tab6_result_psp.Text = "ค่าสารบ่งชี้มะเร็งต่อมลูกหมากสูงกว่าปกติ ตรวจติดตามกับศัลยแพทย์ระบบทางเดินปัสสาวะ"
                            End If
    ...
    Private Sub clear()
        ...
        tab1_result_eye.Text = "ตรวจตาโดยจักษูแพทย์ สายตาปกติ"
        ...
        tab4_result_us.Text = "อยู่ในเกณฑ์ปกติ (Normal)"
        ...
        If e.KeyCode = "13" Then
            ...
            Try
                    ...
                    While mySqlReader.Read()
                        ...
                        Else
                            ...
                            If IsNumeric(tab2_txt_hb.Text) Then
                                txt_hb = Double.Parse(tab2_txt_hb.Text)
                                If txt_hb < 12.0 Then
                                    result_redmorphology = result_redmorphology + "ตรวจความสมบูรณ์ของเม็ดเลือด มีภาวะโลหิตจาง ควรปรึกษาแพทย์เพื่อตรวจหาสาเหตุเพิ่มเติม"
                        ...
                        Else
                            ...
                            If IsNumeric(tab2_txt_wbc.Text) Then
                                txt_wbc = Double.Parse(tab2_txt_wbc.Text)
                                If txt_wbc > 10.0 Then
                                    result_redmorphology = "เม็ดเลือดขาวสูงกว่าปกติ อาจมีการอักเสบหรือติดเชื่อในร่างกาย ควรตรวจซ้ำ"
                                ElseIf txt_wbc > 3.5 And txt_wbc < 4.9 Then
                                    result_redmorphology = "ต่ำกว่าเกณฑ์ปกติเล็กน้อย ควรติดตาม"
                                ElseIf txt_wbc <= 3.5 Then
                                    result_redmorphology = "ต่ำกว่าเกณฑ์ปกติ แนะนำปรึกษาแพทย์"
                                End If
                            End If
                        ...
                        If mySqlReader("R67") Is DBNull.Value Then
                            ...
                            tab6_txt_pap.Text = " "
                        Else
                            If IsNumeric(mySqlReader("R67")) Then
                                tab6_txt_pap.Text = mySqlReader("R67")
                                Dim int_afp As Double
                                int_afp = Double.Parse(tab6_txt_pap.Text)
                                tab6_txt_pap.Text = int_afp
                                ...
                                ElseIf int_afp > 4 Then
                                    tab6_result_psp.Text = "ตรวจติดตามกับศัลยแพทย์ระบบทางเดินปัสสาวะ"
                                End If
                            End If
                ...
                Else
                    ...
                    Dim NextForm As frmpackage5_1 = New frmpackage5_1(mysqlpass, ipconnect, usernamedb, dbname, txtsearch.Text)
    ...
    Private Sub txt_date_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    End Sub
    ...
    Private Sub ComboBox5_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ComboBox5.SelectedValueChanged
        If ComboBox5.Text = "1.Normal" Then
            tab4_result_us.Text = "อยู่ในเกณฑ์ปกติ (Normal)"
        ElseIf ComboBox5.Text = "2.ไขมันเกาะตับ" Then
            tab4_result_us.Text = "ไขมันเกาะตับ ลดอาหารไขมัน งดดื่มสุรา / เบียร์ ออกกำลังกายสม่ำเสมอ และตรวจติดตามทุกปี"
        ElseIf ComboBox5.Text = "3.นิ่วในถุงน้ำดี" Then
            tab4_result_us.Text = "นิ่วในถุงน้ำดี ตรวจติดตามโดยศัลยแพทย์ เพื่อรับแนะนำเกี่ยวกับการรักษาต่อไป"
        ElseIf ComboBox5.Text = "4.เข้าได้กับภาวะตับแข็ง" Then
            tab4_result_us.Text = "เข้าได้กับภาวะตับแข็ง ตรวจติดตามโดยศัลยแพทย์ เพื่อรับแนะนำในการรักษาต่อไป"
        End If
    End Sub
    ...
    Private Sub ComboBox23_SelectedValueChanged(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Public Sub bmi_cal()
        ...
        If tab1_tab_weight.Text <> " " And tab1_txt_height.Text <> " " And IsNumeric(tab1_txt_height.Text) And (IsNumeric(tab1_tab_weight.Text)) Then
    ...
    Public Sub check_box()
        ...
        If ComboBox7.Text = "2.ผิดปกติ" Then
            ...
            count_result = count_result + 1
        End If
        If ComboBox8.Text = "2.ผิดปกติ" Then
        ...
        Else
            int_ldl = 0
            tab6_result_ldl.Text = "หาค่าไม่ได้เนื่องจาก ไขมันไตรกลีเซอไรด์สูงมาก แนะนำพบแพทย์เพื่อทำการรักษา"
        End If
        ...
        If ComboBox5.Text = "2.ไขมันเกาะตับ" Then
            result_all = result_all + "-ไขมันเกาะตับ ลดอาหารไขมัน งดดื่มสุรา / เบียร์ ออกกำลังกายสม่ำเสมอ และตรวจติดตามทุกปี" + Environment.NewLine
            count_result = count_result + 1

        ElseIf ComboBox5.Text = "3.นิ่วในถุงน้ำดี" Then
            result_all = result_all + "-นิ่วในถุงน้ำดี ตรวจติดตามโดยศัลยแพทย์ เพื่อรับคำแนะนำเกี่ยวกับการรักษาต่อไป" + Environment.NewLine
            count_result = count_result + 1

        ElseIf ComboBox5.Text = "4.เข้าได้กับภาวะตับแข็ง" Then
            result_all = result_all + "-เข้าได้กับภาวะตับแข็ง ตรวจติดตามโดยศัลยแพทย์ เพื่อรับคำแนะนำในการรักษาต่อไป" + Environment.NewLine
            count_result = count_result + 1
        ...
        If ComboBox19.Text = "2.ผิดปกติ" And tab6_result_psp.Text = "กรุณากรอกข้อมูล" Then
            check_group = check_group + "- ตรวจสอบ สรุปผล วิเคราะห์ผล PAP หรือ PSP" + Environment.NewLine
            count_group = count_group + 1
            check_form = "1"
    ...
    Public Sub savedata()
        ...
        Try
            ...
            mySqlCommand.CommandText = "INSERT INTO healthycare_ryh (p_id,p_name,p_sex,p_age,p_tell,p_add,p_aid,p_date,p_height,p_weight,p_bmi,p_pulse,p_blood_pre,p_eyeright,p_eyeleft,blo_gro,blo_rhe,blo_pla,blo_cbc_hb,blo_cbc_hct,blo_cbc_wbc,blo_cbc_n,blo_cbc_e,blo_cbc_b,blo_cbc_l,blo_cbc_m,blo_cbc_a,blo_redcell,uri_col,uri_app,uri_alb,uri_glu,uri_spg,uri_blo,uri_ph,uri_rbe,uri_wbc,uri_epi,uri_other,result_phy,xray,result_us,phy_ekg,che_fbs,che_bun,che_cre,che_uri,che_cho,che_tri,che_hdl,che_ldl,che_sgo,che_sgp,che_alk,che_afp,result_psp,package_type,date_time,tab1_result_eye,tab1_result_pulse,tab2_result_redmorphology,tab2_result_platecount,tab3_txt_comment,tab4_result_phy,tab4_result_x_ray,tab4_result_us,tab4_result_ekg,tab4_result_fbs,tab5_result_bun,tab5_result_creatinine,tab5_result_uric_acid,tab5_result_cholesterol,tab5_result_trigyceride,tab5_result_hdl,tab6_result_ldl,tab6_result_sgot,tab_result_spgt,tab6_result_alkaline,tab6_result_afp,tab6_result_psp,result_all,txt_dental) VALUES ('" & txtsearch.Text & "','" & txt_name.Text & "','" & txt_sex.Text & "','" & txt_age.Text & "','" & txt_tell.Text & "','" & txt_address.Text & "','" & txt_aid.Text & "','" & txt_date.Text & "','" & tab1_txt_height.Text & "','" & tab1_tab_weight.Text & "','" & tab1_txt_bmi.Text & "','" & tab1_txt_pulserate.Text & "','" & tab1_txt_bloodp.Text & "','" & tab1_txt_eyer.Text & "', '" & tab1_txt_eyel.Text & "','" & tab2_txt_groupblood.Text & "','" & tab2_txt_rh.Text & "','" & tab2_txt_plate.Text & "','" & tab2_txt_hb.Text & "','" & tab2_txt_hct.Text & "','" & tab2_txt_wbc.Text & "','" & tab2_txt_neutrophils.Text & "','" & tab2_txt_eosinophils.Text & "','" & tab2_txt_bashophils.Text & "','" & tab2_txt_lymphocytes.Text & "','" & tab2_txt_monocytes.Text & "','" & tab2_txt_atypical.Text & "','" & tab2_txt_redcell.Text & "','" & tab3_txt_color.Text & "','" & tab3_txt_appearance.Text & "','" & tab3_txt_albumin.Text & "','" & tab3_txt_glucose.Text & "','" & tab3_txt_spgr.Text & "','" & tab3_txt_blood.Text & "','" & tab3_txt_ph.Text & "','" & tab3_txt_rbc.Text & "','" & tab3_txt_wbc.Text & "','" & tab3_txt_epi.Text & "','" & tab3_txt_other.Text & "','" & tab4_result_phy.Text & "','" & tab4_result_x_ray.Text & "','" & tab4_result_us.Text & "','" & tab4_result_ekg.Text & "','" & tab4_txt_fbs.Text & "','" & tab5_txt_bun.Text & "','" & tab5_txt_creatinine.Text & "','" & tab5_txt_uricacid.Text & "','" & tab5_txt_cholesterol.Text & "','" & tab5_txt_trigyceride.Text & "','" & tab5_txt_hdl.Text & "','" & tab6_txt_ldl.Text & "','" & tab6_txt_sgot.Text & "','" & tab6_txt_sgpt.Text & "','" & tab6_txt_alkaline.Text & "','" & tab6_txt_afp.Text & "','" & tab6_result_psp.Text & "','P5','" & Date.Now.Date.ToString & "','" & tab1_result_eye.Text & "','" & tab1_result_pulse.Text & "','" & tab2_result_redmorphology.Text & "','" & tab2_result_platecount.Text & "','" & tab3_txt_comment.Text & "','" & tab4_result_phy.Text & "','" & tab4_result_x_ray.Text & "','" & tab4_result_us.Text & "','" & tab4_result_ekg.Text & "','" & tab4_result_fbs.Text & "','" & tab5_result_bun.Text & "','" & tab5_result_creatinine.Text & "','" & tab5_result_uricacid.Text & "','" & tab5_result_cholesterol.Text & "','" & tab5_result_trigyceride.Text & "','" & tab5_result_hdl.Text & "','" & tab6_result_ldl.Text & "','" & tab6_result_sgot.Text & "','" & tab6_result_spgt.Text & "','" & tab6_result_alkaline.Text & "','" & tab6_result_afp.Text & "','" & tab6_result_psp.Text & "','" & RichTextBox2.Text & "','" & txt_dental.Text & "');"
    ...
    Public Sub excelReport()
        ...
        With excelsheets
            ...
            .Range("B169:K169").Borders(9).Weight = 2 ' xlThin
            .Range("B191:K191").Borders(9).Weight = 2 ' xlThin
            ...
            With .Range("B36:K36")
                .Merge()
                .Value = "ตรวจต้อหินและตรวจตาโดยจักษุแพทย์ "
                .Font.Bold = True
                .Font.Size = 14
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignTop
            End With
            With .Range("B37")
                .Value = "( Glaucoma and Eyes examination by Ophthalmologist ) :"
                .Font.Bold = True
                .Font.Size = 15
                .HorizontalAlignment = Excel.Constants.xlLeft
            ...
            With .Range("B76:K76")
                .Merge()
                .Value = "อัลตร้าซาวด์ดูอวัยวะในช่องท้องทั้งหมด (U/S Whole Abdomen)"
                .Font.Size = 14
                .Font.Bold = True
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            ...
            With .Range("B130:K130")
                .Merge()
                .Value = "ตรวจระดับไขมันในเลือด (ปริมาณไขมันความหนาแน่นสูง/HDL)"
                .Font.Bold = True
                .Font.Size = 14
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            ...
            With .Range("D131")
                .Merge()
                .Value = tab5_txt_hdl.Text
                .Font.Size = 14
                If IsNumeric(tab5_txt_hdl.Text) Then

                    If tab5_txt_hdl.Text.Length > 1 Then
                        If CDbl(tab5_txt_hdl.Text) > 60 Or CDbl(tab5_txt_hdl.Text) < 40 And IsNumeric(tab5_txt_hdl.Text) Then
                            .Font.Bold = True
                        Else
                            .Font.Bold = False
                        End If
            ...
            With .Range("B136:K136")
                .Merge()
                .Value = "ตรวจระดับไขมันในเลือด (ปริมาณไขมันความหนาแน่นต่ำ/LDL)"
                .Font.Bold = True
                .Font.Size = 14
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            ...
            With .Range("D137")
                .Merge()
                .Value = tab6_txt_ldl.Text
                If IsNumeric(tab6_txt_ldl.Text) Then
                    If tab6_txt_ldl.Text.Length > 1 Then
                        If CDbl(tab6_txt_ldl.Text) > 100 And IsNumeric(tab6_txt_ldl.Text) Then
                            .Font.Bold = True
                        Else
                            .Font.Bold = False
                        End If
            ...
            With .Range("B157:K157")
                .Merge()
                .Value = "ตรวจการอุดกั้นทางเดินน้ำดี (Alkaline Phosphatase)"
                .Font.Bold = True
                .Font.Size = 14
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            ...
            With .Range("D158")
                .Merge()
                .Value = tab6_txt_alkaline.Text
                If IsNumeric(tab6_txt_alkaline.Text) Then

                    If tab6_txt_alkaline.Text.Length > 1 Then
                        If CDbl(tab6_txt_alkaline.Text) > 126 Or CDbl(tab6_txt_alkaline.Text) < 38 And IsNumeric(tab6_txt_alkaline.Text) Then
                            .Font.Bold = True
                        Else
                            .Font.Bold = False
                        End If
            ...
            With .Range("K158")
                ...
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            End With
            With .Range("B159:K162")
                .Merge()
                .Value = tab6_result_alkaline.Text
                .Font.Size = 14
                If IsNumeric(tab6_txt_alkaline.Text) Then
                    If tab6_txt_alkaline.Text.Length > 1 Then
                        If CDbl(tab6_txt_alkaline.Text) > 126 Or CDbl(tab6_txt_alkaline.Text) < 38 And IsNumeric(tab6_txt_alkaline.Text) Then
            ...
            With .Range("B163:K163")
                .Merge()
                .Value = "ตรวจหาสารบ่งชี้มะเร็งในตับ (AFP)"
                .Font.Bold = True
                .Font.Size = 14
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            ...
            With .Range("D164")
                .Merge()
                If IsNumeric(tab6_txt_afp.Text) Then
                    If tab6_txt_afp.Text.Length > 1 Then

                        If IsNumeric(tab6_txt_afp.Text) Then
                            If CDbl(tab6_txt_afp.Text) > 7.51 Then
                                .Font.Bold = True
                            Else
                                .Font.Bold = False
                            End If
            ...
            With .Range("K164")
                ...
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            End With
            With .Range("B165:K167")
                .Merge()
                .Value = tab6_result_afp.Text
                If IsNumeric(tab6_txt_afp.Text) Then
                    If tab6_txt_afp.Text.Length > 1 Then
                        If IsNumeric(tab6_txt_afp.Text) Then
                            If CDbl(tab6_txt_afp.Text) > 7.51 Then
            ...
            With .Range("B170:K170")
                .Merge()
                .Value = "ตรวจหาสารบ่งชี้มะเร็งต่อมลูกหมาก (PSA)"
                .Font.Bold = True
                .Font.Size = 14
                .HorizontalAlignment = Excel.Constants.xlLeft
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            ...
            With .Range("D171")
                .Merge()
                If IsNumeric(tab6_txt_pap.Text) Then
                    If tab6_txt_pap.Text.Length > 1 Then

                        If IsNumeric(tab6_txt_pap.Text) Then
                            If CDbl(tab6_txt_pap.Text) > 4 Then
                                .Font.Bold = True
                            Else
                                .Font.Bold = False
                            End If
            ...
            With .Range("K171")
                ...
                .VerticalAlignment = Excel.XlVAlign.xlVAlignCenter
            End With
            With .Range("B172:K175")
                .Merge()
                .Value = tab6_result_psp.Text
                If IsNumeric(tab6_txt_pap.Text) Then
                    If tab6_txt_pap.Text.Length > 1 Then
                        If IsNumeric(tab6_txt_pap.Text) Then
                            If CDbl(tab6_txt_pap.Text) > 7.51 Then
                                .Font.Bold = True
                            End If
                        End If
                    End If
        ...
        Try
            excelbooks.SaveAs(pathExcel.ToString + "\" + txt_name.Text + "_P.6" + ".xlsx")
    ...
    Private Sub ListView2_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If ComboBox8.Text <> "1.ปกติ" Then
            resulteye = resulteye + ListView2.SelectedItems(0).SubItems(0).Text
            tab1_result_eye.Text = resulteye
        Else
            tab1_result_eye.Text = "ตรวจตาโดยจักษูแพทย์ สายตาปกติ"
        End If
    ...
    Private Sub ListView5_Click(ByVal sender As Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub ListView2_DoubleClick1(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub ListView5_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        dentall = dentall + ListView5.SelectedItems(0).SubItems(0).Text
        txt_dental.Text = dentall


    End Sub

    Private Sub TabPageEX4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TabPageEX4.Click

    End Sub

    Private Sub ComboBox2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox7.SelectedIndexChanged
