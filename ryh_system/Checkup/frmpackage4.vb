...
Public Class frmpackage4
    ...
    End Sub
    Private Sub frmpackage4_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
                    ...
                    Else
                        ...
                        If IsNumeric(tab6_txt_ldl.Text) Then
                            ...
                            ElseIf int_ldl > 100 Then
                                If check_sub = 0 Then
                                    tab6_result_ldl.Text = "ไขมันในเลือดสูง แนะนำ หลีกเลี่ยงหรือลดอาหารประเภทไขมันมาก ได้แก่ อาหารทะเล ไข่แดง เครื่องในสัตว์  เป็นต้น ออกกำลังกายสม่ำเสมอ และตรวจติดตาม หรือตามคำแนะนำของแพทย์"
                                ElseIf check_sub = 1 Then
        ...
        If e.KeyCode = "13" Then
            ...
            If string_count = 1 Then
                ...
                While mySqlReader.Read()
                    ...
                    End If
                    If mySqlReader("R60") Is DBNull.Value Or mySqlReader("R60") = "-" Then
                        tab6_txt_ldl.BackColor = Color.DarkSeaGreen
                    Else
                        tab6_txt_ldl.Text = mySqlReader("R60")
                        Dim int_ldl As Integer
    ...
    Public Sub savedata()
        ...
        Try
            ...
            mySqlCommand.CommandText = "INSERT INTO healthycare_ryh (p_id,p_name,p_sex,p_age,p_tell,p_add,p_aid,p_date,p_height,p_weight,p_bmi,p_pulse,p_blood_pre,blo_gro,blo_rhe,blo_pla,blo_cbc_hb,blo_cbc_hct,blo_cbc_wbc,blo_cbc_n,blo_cbc_e,blo_cbc_b,blo_cbc_l,blo_cbc_m,blo_cbc_a,blo_redcell,uri_col,uri_app,uri_alb,uri_glu,uri_spg,uri_blo,uri_ph,uri_rbe,uri_wbc,uri_epi,uri_other,result_phy,xray,result_us,phy_ekg,che_fbs,che_bun,che_cre,che_uri,che_cho,che_tri,che_hdl,che_ldl,che_sgo,che_sgp,che_alk,package_type,date_time,tab1_result_pulse,tab2_result_redmorphology,tab2_result_platecount,tab3_txt_comment,tab4_result_phy,tab4_result_x_ray,tab4_result_us,tab4_result_ekg,tab4_result_fbs,tab5_result_bun,tab5_result_creatinine,tab5_result_uric_acid,tab5_result_cholesterol,tab5_result_trigyceride,tab5_result_hdl,tab6_result_sgot,tab_result_spgt,tab6_result_alkaline,result_all,p_eyeright,p_eyeleft,tab1_result_eye,txt_dental) VALUES ('" & txtsearch.Text & "','" & txt_name.Text & "','" & txt_sex.Text & "','" & txt_age.Text & "','" & txt_tell.Text & "','" & txt_address.Text & "','" & txt_aid.Text & "','" & txt_date.Text & "','" & tab1_txt_height.Text & "','" & tab1_tab_weight.Text & "','" & tab1_txt_bmi.Text & "','" & tab1_txt_pulserate.Text & "','" & tab1_txt_bloodp.Text & "','" & tab2_txt_groupblood.Text & "','" & tab2_txt_rh.Text & "','" & tab2_txt_plate.Text & "','" & tab2_txt_hb.Text & "','" & tab2_txt_hct.Text & "','" & tab2_txt_wbc.Text & "','" & tab2_txt_neutrophils.Text & "','" & tab2_txt_eosinophils.Text & "','" & tab2_txt_bashophils.Text & "','" & tab2_txt_lymphocytes.Text & "','" & tab2_txt_monocytes.Text & "','" & tab2_txt_atypical.Text & "','" & tab2_txt_redcell.Text & "','" & tab3_txt_color.Text & "','" & tab3_txt_appearance.Text & "','" & tab3_txt_albumin.Text & "','" & tab3_txt_glucose.Text & "','" & tab3_txt_spgr.Text & "','" & tab3_txt_blood.Text & "','" & tab3_txt_ph.Text & "','" & tab3_txt_rbc.Text & "','" & tab3_txt_wbc.Text & "','" & tab3_txt_epi.Text & "','" & tab3_txt_other.Text & "','" & tab4_result_phy.Text & "','" & tab4_result_x_ray.Text & "','','" & tab4_result_ekg.Text & "','" & tab4_txt_fbs.Text & "','" & tab5_txt_bun.Text & "','" & tab5_txt_creatinine.Text & "','" & tab5_txt_uricacid.Text & "','" & tab5_txt_cholesterol.Text & "','" & tab5_txt_trigyceride.Text & "','" & tab5_txt_hdl.Text & "','" & tab6_txt_ldl.Text & "','" & tab6_txt_sgot.Text & "','" & tab6_txt_sgpt.Text & "','" & tab6_txt_alkaline.Text & "','P4','" & Date.Now.Date.ToString & "','" & tab1_result_pulse.Text & "','" & tab2_result_redmorphology.Text & "','" & tab2_result_platecount.Text & "','" & tab3_txt_comment.Text & "','" & tab4_result_phy.Text & "','" & tab4_result_x_ray.Text & "','','" & tab4_result_ekg.Text & "','" & tab4_result_fbs.Text & "','" & tab5_result_bun.Text & "','" & tab5_result_creatinine.Text & "','" & tab5_result_uricacid.Text & "','" & tab5_result_cholesterol.Text & "','" & tab5_result_trigyceride.Text & "','" & tab5_result_hdl.Text & "','" & tab6_result_sgot.Text & "','" & tab6_result_spgt.Text & "','" & tab6_result_alkaline.Text & "','" & RichTextBox2.Text & "','" & tab1_txt_eyer.Text & "','" & tab1_txt_eyel.Text & "','" & tab1_result_eye.Text & "','" & txt_dental.Text & "');"
    ...
    Private Sub txt_search_doctor_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Public Sub excelReport()
        ...
        Try
            excelbooks.SaveAs(pathExcel.ToString + "\" + txt_name.Text + "_P.4" + ".xlsx")
    ...
    Private Sub tab5_result_bun_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles tab5_result_bun.TextChanged
    ...
    Private Sub ListView2_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        tab1_result_eye.Text = tab1_result_eye.Text + ListView2.SelectedItems(0).SubItems(0).Text
    End Sub
