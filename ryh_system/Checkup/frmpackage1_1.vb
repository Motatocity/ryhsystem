...
Public Class frmpackage1_1
    ...
    Private Sub frmpackage1_1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim NextForm As frmpackage1 = New frmpackage1(mysqlpass, ipconnect, usernamedb, dbname, "0", "0")
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        Dim NextForm As frmpackage1 = New frmpackage1(mysqlpass, ipconnect, usernamedb, dbname, id_hn, export_id)
        '  Dim NextForm As main_user = New main_user()
        NextForm.Show()
        Me.Close()
    End Sub
