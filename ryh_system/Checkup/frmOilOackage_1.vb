...
Public Class frmOilOackage_1
    ...
    Public Sub New(ByRef mysql_pass As String, ByRef ip_connect As String, ByRef user_namedb As String, ByRef db_name As String, ByRef hn As String, ByRef company As String)
    ...
    Private Sub frmOilOackage_1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            While (mySqlReader.Read())
                ...
                With ListView1.Items.Add(mySqlReader("checkup_export_id"))
                    ...
                    .SubItems.Add(Format(mySqlReader("export_date"), "dd/MM/yyyy"))
                End With
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim NextForm As frmOilPackage = New frmOilPackage(mysqlpass, ipconnect, usernamedb, dbname, idcompany, "0", "0")
    ...
    Private Sub ListView1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.Click
        ...
        Dim NextForm As frmOilPackage = New frmOilPackage(mysqlpass, ipconnect, usernamedb, dbname, idcompany, id_hn, export_id)
        '  Dim NextForm As main_user = New main_user()
        NextForm.Show()
        Me.Close()
    End Sub
