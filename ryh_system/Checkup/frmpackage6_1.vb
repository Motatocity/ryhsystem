...
Public Class frmpackage6_1
    ...
    Dim check_sub_thai As String

    Public Sub New(ByRef mysql_pass As String, ByRef ip_connect As String, ByRef user_namedb As String, ByRef db_name As String, ByRef hn As String, ByRef check_sub As String)
    ...
    End Sub
    Private Sub frmpackage6_1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ListView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.DoubleClick
        ...
        Dim NextForm As frmpackage6 = New frmpackage6(mysqlpass, ipconnect, usernamedb, dbname, id_hn, export_id, check_sub_thai)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Dim NextForm As frmpackage6 = New frmpackage6(mysqlpass, ipconnect, usernamedb, dbname, "0", "0", "0")
        '  Dim NextForm As main_user = New main_user()
        NextForm.Show()
        Me.Close()
    End Sub
