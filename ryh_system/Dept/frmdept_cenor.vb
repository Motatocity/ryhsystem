...
Public Class frmdept_cenor
    ...
    Private Sub frmdept_cenor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        loadcen()
    End Sub
    Public Sub loadcen()
        mysql.Close()
        ...
        mySqlCommand.CommandText = "SELECT * FROM census_main join census_or  on census_main.idcensus_main  = census_or.ormain   where cendep = '" & frmlogin_dept.dept & "' ;"
    ...
    Public Sub selectdb()
        ...
        mySqlCommand.CommandText = "SELECT * FROM census_main join census_or  on census_main.idcensus_main  = census_or.ormain where idcensus_main ='" & DataGridViewX1.Rows(inbtIndex).Cells(7).Value & "';"
        mySqlCommand.Connection = mysql
        mySqlAdaptor.SelectCommand = mySqlCommand
        ...
        Try
            ...
            While (mySqlReader.Read())
                ...
                idsubmain = mySqlReader("idcensus_or")
                ...
                TextBoxX17.Text = mySqlReader("orsum")
                TextBoxX18.Text = mySqlReader("ormajor")
                TextBoxX19.Text = mySqlReader("orminor")
                TextBoxX26.Text = mySqlReader("orsmall")
                TextBoxX27.Text = mySqlReader("orscope")
                ...
                If respone = 1 Then
                    ...
                    ElseIf checksu = "1" Then
                        ...
                        If mysql.State = ConnectionState.Closed Then
                            mysql.Open()
                        End If
                        commandText2 = "UPDATE census_or SET orsum = '" & TextBoxX17.Text & "',ormajor = '" & TextBoxX18.Text & "',orminor ='" & TextBoxX19.Text & "',orsmall = '" & TextBoxX26.Text & "',orscope ='" & TextBoxX27.Text & "' WHERE idcensus_or = '" & idsubmain & "'; "
