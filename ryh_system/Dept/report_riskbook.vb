...
Public Class report_riskbook
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ryh_system.report_riskbook.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedreport_riskbook
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As report_riskbook = New report_riskbook()
        rpt.Site = Me.Site
        Return rpt
    End Function
