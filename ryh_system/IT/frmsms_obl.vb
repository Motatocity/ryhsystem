...
Imports System.Data
Public Class frmsms_obl
    Dim MyODBCConnection As New OdbcConnection("Dsn=RYHPFV5;uid=mse;Password=m0116;")
    ...
    Private Sub frmsms_obl_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
    ...
    Public Sub loaduser()
        ...
        Dim selectCMD As OdbcCommand = New OdbcCommand("SELECT RYHPFV5.OPDNAMV5PF.OAPHN, RYHPFV5.OPDNAMV5PF.OAPREGDTE, RYHPFV5.OPDNAMV5PF.OAPSECTIM, RYHPFV5.REGDETV5PF.RDTTEL,RYHPFV5.REGDETV5PF.RDTMOBTEL FROM   RYHPFV5.OPDNAMV5PF, RYHPFV5.REGDETV5PF  WHERE (RYHPFV5.OPDNAMV5PF.OAPHN = RYHPFV5.REGDETV5PF.RDTHN) AND (RYHPFV5.OPDNAMV5PF.OAPCRDSTS = 'Q') and RYHPFV5.OPDNAMV5PF.OAPSECTIM >= '" & timecheck & "' order by OAPSECTIM DESC ")
